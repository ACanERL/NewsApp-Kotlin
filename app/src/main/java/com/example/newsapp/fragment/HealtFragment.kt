...
import com.example.newsapp.databinding.FragmentHealtBinding
import com.example.newsapp.viewmodel.NewsViewModel


class HealtFragment : Fragment() {
    private var _binding: FragmentHealtBinding?=null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
       ...
       _binding= FragmentHealtBinding.inflate(inflater,container,false)
        viewModel= ViewModelProvider(requireActivity())[NewsViewModel::class.java]

        viewModel.healtResponse.observe(viewLifecycleOwner, Observer {
